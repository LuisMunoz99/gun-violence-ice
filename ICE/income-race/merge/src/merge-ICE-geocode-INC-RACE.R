...
# args {{{
args <- list(input1 = here("ICE/income-race/adjust-income/export/output/IceIncRace-adjusted.csv"),
             input2 = here("geocode/transform-cords/export/output/geocoded-coords.csv"),  # SF import
             output = here("ICE/income-race/merge/output/IceIncRace-geo-final.csv")) # Output ICE with SF 
# }}}
...
# -- Export ---
out <- census_data %>%
  left_join(sf_child_firearm, by = "GEOID")  %>%
